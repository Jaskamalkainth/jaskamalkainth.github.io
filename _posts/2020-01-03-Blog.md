  ...
  <section class="category-section">
    ...
    <div class="post-grid">
      ...
      <div class="post-card">
        ...
        <p>From 한글 (Hangul) basics to complex grammar structures - documenting my adventure in mastering Korean, complete with study materials, progress tracking, and cultural insights.</p>
        <div class="multi-link">
          <a href="/blog_posts/korean-learning-notes.html" target="_blank" class="post-link">
            <i class="fa fa-external-link"></i> Read
          </a>
          <a href="https://github.com/Jaskamalkainth/korean-language-learning-notes/tree/main" target="_blank" class="post-link">
            <i class="fab fa-github"></i> Notes
          </a>
        </div>
